...
function PlatformManager() {
    ...
    this.second = new Platform({x: (this.first.x + this.first.width) + random(this.maxDistanceBetween - 150,
    this.maxDistanceBetween), y: random(this.first.y - 128, InfiniteRunner.height - 80), width: 400, height: 70})
    this.third = new Platform({x: (this.second.x + this.second.width) + random(this.maxDistanceBetween - 150,
    this.maxDistanceBetween), y: random(this.second.y - 128, InfiniteRunner.height - 80), width: 400, height: 70})
...
PlatformManager.prototype.update = function() {
    ...
    if(this.third.x + this.third.width < 0) {
        ...
        this.third.y = random(this.first.y - 32, InfiniteRunner.height - 80);
...
InfiniteRunner.reszie = function() {
